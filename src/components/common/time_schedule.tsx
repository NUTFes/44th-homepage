    ...
    <div className="text-center flex flex-col gap-y-4">
      <div className="body2 text-font_khaki">
        ...
        <Carousel autoSlide={false}>
          <div className="px-4">
            <p className="font-bold text-font_khaki">1日目（8/13）スケジュール・晴れ</p>
            <ZoomableImage>
              <ImageModal
          ...
          <div className="px-4">
            <p className="font-bold text-font_khaki">1日目（8/13）スケジュール・雨</p>
          <ZoomableImage>
            <ImageModal
          ...
          <div className="px-4">
            <p className="font-bold text-font_khaki">2日目（8/14）スケジュール・晴れ</p>
          <ZoomableImage>
          ...
          <div className="px-4">
            <p className="font-bold text-font_khaki">2日目（8/14）スケジュール・雨</p>
          <ZoomableImage>
            <ImageModal
