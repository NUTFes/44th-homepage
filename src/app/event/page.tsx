        ...
        <div className="flex flex-col text-center gap-y-8 py-4 relative">
          ...
          <div className="flex flex-col gap-y-4">
            <div className="flex justify-between px-8 items-center">
              ...
              <LinkButton href="/event/guest" className="px-4 py-2 hover:opacity-80">
                詳しく見る＞＞
              </LinkButton>
            </div>
            <div className="px-8">
          ...
          <div className="flex justify-between px-8 items-center">
            ...
            <LinkButton href="/event/plan" className="px-4 py-2  hover:opacity-80">
              もっと見る＞＞
            </LinkButton>
          </div>
          <div>
          ...
          <div className="flex justify-between px-8 items-center">
            ...
            <LinkButton href="/event/exh_exp" className="px-4 py-2  hover:opacity-80">
              もっと見る＞＞
            </LinkButton>
          </div>
          <div>
